...
from .utils import sphere, closest_integer_point, bresenham3d, l2norm, l2normarray, diagonal_dot
...
2002 Nov;17(3):143-55. doi: 10.1002/hbm.10062. PMID: 12391568; PMCID: PMC6871816.
    ...
    def update_params(self, info, state):
        [t02t, t98t, bt, d1, d2, rmin, rmax,n_iter] = info
        # store brain extraction parameters
    ...
    def initialization(self, progressBar, lbl_status):
        pv = self._progress
        progressBar.setValue(pv+1)
        ...
        lbl_status.setText('Initializing surface...')
        ...
        progressBar.setValue(pv + 7)
        self._progress += 12
        self.update_surface_attributes(progressBar)
    ...
    def rebuild_surface(self, progressBar):
        """
    ...
    def update_surface_attributes(self, progressBar):
        """
        Updates attributes related to the surface
        """
        init = self._progress
        progressBar.setValue(init+1)
    ...
    def run(self, progressBar, lbl_status):
        """
        ...
        for i in range(iterations):
            ...
            lbl_status.setText('{}/{}'.format(i+1, iterations))
            progressBar.setValue(self._progress)
        ...
        progressBar.setValue(self._progress)
        # update the surface
        self.rebuild_surface(progressBar)
        lbl_status.setText('Post Processing...')
