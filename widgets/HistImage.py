...
class HistImage(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.widget), _translate("Dialog", "MRI"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.widget2), _translate("Dialog", "US"))
