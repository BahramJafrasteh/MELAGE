...
import random
import matplotlib
from widgets.HistImage import FigureCanvas
matplotlib.use('Agg')
...
class ThresholdingImage(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.gridLayout2.addWidget(self.button, 0, 3, 1, 1)
        ...
        self._label_numberClasses.setText(_translate("Form", "Number of classes"))
